...
`startUpload` launches the upload widget which gives us the freedom to upload images or videos. After the upload we set the value either the banner or trailer model depending on which button was clicked.
